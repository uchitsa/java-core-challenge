...
public class TaskT01N15 {
    ...
    public static boolean conditionA(int x, int y) {
        return (x % 2 == 1) && (y % 2 == 1);
    }

    public static boolean conditionB(int x, int y) {
        return (x < 20) ^ (y < 20);
    }

    public static boolean conditionC(int x, int y) {
        return (x == 0) || (y == 0);
    }

    public static boolean conditionD(int x, int y, int z) {
        return (x < 0) && (y < 0) && (z < 0);
    }

    public static boolean conditionE(int x, int y, int z) {
        return ((x % 5 == 0) && (y % 5 != 0) && (z % 5 != 0))
                || ((x % 5 != 0) && (y % 5 == 0) && (z % 5 != 0))
                || ((x % 5 != 0) && (y % 5 != 0) && (z % 5 == 0));
    }

    public static boolean conditionF(int x, int y, int z) {
